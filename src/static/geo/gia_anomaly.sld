        ...
        <sld:Rule>
          <sld:RasterSymbolizer>
            ...
            <sld:ColorMap type="intervals">
              <sld:ColorMapEntry color="#67001F" label="-1000.00 to -800.00 m" quantity="-800"/>
              <sld:ColorMapEntry color="#B2182B" label="-800.00 to -600.00 m" quantity="-600"/>
              <sld:ColorMapEntry color="#D6604D" label="-600.00 to -400.00 m" quantity="-400"/>
              <sld:ColorMapEntry color="#F4A582" label="-400.00 to -200.00 m" quantity="-200"/>
              <sld:ColorMapEntry color="#FDDBC7" label="-200.00 to 0.00 m" quantity="0"/>
