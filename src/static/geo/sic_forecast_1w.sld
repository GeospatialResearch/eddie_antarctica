...
<StyledLayerDescriptor xmlns:sld="http://www.opengis.net/sld" xmlns="http://www.opengis.net/sld"
                       version="1.0.0">
    <UserLayer>
        ...
        <sld:UserStyle>
            <sld:Name>sic_forecast_1w</sld:Name>
                ...
                <sld:Rule>
                    <sld:RasterSymbolizer>
                        ...
                        <sld:ColorMap type="intervals">
                            <sld:ColorMapEntry color="#08306b" label="Open water (0% SIC)" quantity="0.001" opacity="0"/>
                            <sld:ColorMapEntry color="#08306b" label="Trace ice, under 15% SIC" quantity="0.15"/>
